...
const ActionPreview = ({
  ...
  if (type === TRANSACTION_BLOCK_TYPE.KLIMA_STAKE) {
    ...
    return (
      <Card
        key={`preview-klima-${crossChainAction.id}`}
        title="Klima Staking"
        marginBottom={20}
  ...
  if (type === TRANSACTION_BLOCK_TYPE.ASSET_BRIDGE) {
    ...
    return (
      <Card
        key={`preview-bridge-${crossChainAction.id}`}
        title="Asset bridge"
        marginBottom={20}
        onCloseButtonClick={onRemove}
        showCloseButton={showCloseButton}
  ...
  const previewSend = (
    ...
    return (
      <TransactionAction key={`preview-send-${i}`}>
        <Label>You send</Label>
        <ValueWrapper>
          <CombinedRoundedImages
            title={asset.symbol}
  ...
  const previewSwap = (
    ...
    return (
      <DoubleTransactionActionsInSingleRow key={`preview-swap-${i}`}>
        <TransactionAction>
          <Label>You send</Label>
          <ValueWrapper>
            <CombinedRoundedImages
  ...
  if (type === TRANSACTION_BLOCK_TYPE.SEND_ASSET) {
    ...
    return (
      <Card
        key={`preview-send-${crossChainAction.id}`}
        title="Send asset"
        marginBottom={20}
        onCloseButtonClick={onRemove}
        showCloseButton={showCloseButton}
  ...
  if (type === TRANSACTION_BLOCK_TYPE.ASSET_SWAP) {
    ...
    return (
      <Card
        key={`preview-swap-${crossChainAction.id}`}
        title="Swap asset"
        marginBottom={20}
        onCloseButtonClick={onRemove}
        showCloseButton={showCloseButton}
