...
export const darkTheme: Theme = {
  ...
  color: {
    background: {
      ...
      selectInputBorder: '#2b2b2a',
      selectInput: '#202020',
      selectInputExpanded: '#202020',
      statusIconPending: '#ff6b35',
      statusIconFailed: '#ff0000',
      statusIconSuccess: '#1ba23d',
      ...
      switchInputActiveTab:
        '#0c3',
      switchInputInactiveTab: '#0c3',
      pill: '#2b2b2a',
      checkboxInputInactive: '#0c3',
      dropdownHoverColor: '#2b2b2a',
      selectInputExpandedHover: '#2b2b2a',
      walletButton: '#0c3',
      walletChainDropdown: '#0c3',
      walletChainButtonActive: '#474078',
      blockParagraphBorder: 'linear-gradient(#346ecd, #cd34a2)',
      listItemQuickButtonPrimary: '#0c3',
      listItemQuickButtonSecondary: '#404250',
      deployButton: '#0c3',
      ...
      scrollbar: '#fbae49',
      walletAssetCopyIcon: '#0c3',
    },
    text: {
      selectInput: '#acafb3',
      selectInputOption: '#f3f2f3',
      selectInputOptionSecondary: '#f3f2f3',
      searchInput: '#0c3',
      searchIcon: '#0c3',
      ...
      tokenTotal: '#f3f2f3',
      tokenValue: '#f3f2f3',
      textInputSecondary: '#f3f2f3',
      switchInputActiveTab: '#f3f2f3',
      transactionStatusLink: '#f3f2f3',
      switchInputInactiveTab: '#f3f2f3',
      selectInputImagePlaceholder: '#f3f2f3',
      listItemQuickButtonPrimary: '#000000',
      cardDisabled: '#605e5e',
      tokenBalance: '#f3f2f3',
      pill: '#f3f2f3',
      pillValue: '#f3f2f3',
      walletDropdownIcon: '#f3f2f3',
      blockParagraphHighlight: '#f3f2f3',
      blockParagraphHighlightSecondary: '#f3f2f3',
      settingsIcon: '#f3f2f3',
      selectAllButton: '#f3f2f3',
      settingsModalSubHeader: '#f3f2f3',
      settingsMenuItem: '#f3f2f3',
      settingsMenuItemHover: '#f3f2f3',
    },
  },
};
