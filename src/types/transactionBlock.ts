...
export type ITransactionBlockType = typeof TRANSACTION_BLOCK_TYPE.ASSET_BRIDGE
...
export type ITransactionBlock = IAssetBridgeTransactionBlock
  | ISendAssetTransactionBlock
  | IAssetSwapTransactionBlock
  | IKlimaStakingTransactionBlock
  | IDisabledTransactionBlock;

export type ITransactionBlockValues = IAssetBridgeTransactionBlockValues
