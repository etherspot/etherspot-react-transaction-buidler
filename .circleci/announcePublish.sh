    ...
    "attachments": [
        {
            ...
            "title_link": "https://github.com/etherspot/etherspot-react-transaction-buidler/releases/tag/$package",
            "text": "Version: etherspot-react-transaction-buidler@$package",
            "ts": $(date '+%s')
        }
    ]
}
